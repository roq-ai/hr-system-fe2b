...
-- AddForeignKey
ALTER TABLE "job_position" ADD CONSTRAINT "job_position_recruiter_id_fkey" FOREIGN KEY ("recruiter_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
